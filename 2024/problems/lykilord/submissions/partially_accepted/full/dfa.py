...
import exceptions
import fa
from utils import PartitionRefinement, get_renaming_function
...
class DFA(fa.FA):
    ...
    def to_complete(self, trap_state: Optional[DFAStateT] = None):
        """
    ...
    def minify(self, retain_names: bool = False):
        """
    ...
    def complement(self, *, retain_names: bool = False, minify: bool = True):
    ...
    def successors(
        ...
        *,
        ...
        coaccessible_nodes = set(self.final_states).union(
            {child for parent, child in nx.bfs_edges(graph, self.final_states, reverse=True)}
        )
    ...
    @classmethod
    def universal_language(cls, input_symbols: AbstractSet[str]):
        """
    ...
    @classmethod
    def empty_language(cls, input_symbols: AbstractSet[str]):
        """
    ...
    @classmethod
    def nth_from_start(
        cls, input_symbols: AbstractSet[str], symbol: str, n: int
    ):
        """
